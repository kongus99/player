							...
							F2(
								function (k, entry) {
									return A2(
										_elm_lang$core$List$filter,
										function (e) {
											return !_elm_lang$core$Native_Utils.eq(e, _p2._0);
										},
										entry);
								}),
							playlist.backlog)
...
var _user$project$Playlist$adder = function (playlist) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Playlist$EditPlaylist),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(playlist.$new),
							_1: {ctor: '[]'}
						}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(playlist.$new),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Playlist$AddPlaylist),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Playlist$lister = function (playlist) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Playlist$DeletePlaylist),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {pool: a, playlist: b, playing: c, edited: d, player: e, storage: f};
	});
var _user$project$Main$init = function () {
	var mdl = A6(_user$project$Main$Model, _elm_lang$core$Dict$empty, _user$project$Playlist$empty, _elm_lang$core$Maybe$Nothing, _user$project$Item$init, _user$project$Player$init, _user$project$Storage$init);
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		mdl,
		{
